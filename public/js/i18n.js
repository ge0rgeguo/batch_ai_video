...
const translations = {
    'zh-CN': {
        ...
        'nav.login': '登录',
        'nav.register': '注册',
        'hero.badge': 'Powered by Sora 2 & Veo 3.1',
        'hero.title': '批量制作，高质量，无水印 AI 视频',
        'hero.subtitle': '一键生成电商营销视频，支持 4K 超高清',
        'hero.cta': '立即登录',
        'hero.note': '无需信用卡 · 新用户赠送积分',
        'feature.batch.title': '批量生成',
        'feature.batch.desc': '单次最多50个视频，10个任务并行处理',
        'feature.nowatermark.title': '无水印',
        'feature.nowatermark.desc': '商用级输出，直接用于电商投放',
        'feature.quality.title': '高清画质',
        'feature.quality.desc': '支持 720p / 1080p / 4K，最长25秒视频',
        'feature.image.title': '图生视频',
        'feature.image.desc': '上传商品图，AI自动生成动态视频',
        'models.header': '选择适合您的模型',
        'stats.videos': '视频已生成',
        'stats.success': '生成成功率',
        'stats.speed': '平均生成时间',
        'stats.support': '全天候服务',
        'cta.title': '准备好开始创作了吗？',
        'cta.subtitle': '立即注册，免费体验AI视频生成',
        ...
        'model.veo31.label': 'Veo 3.1',
        'model.veo31.desc': '适合高端品牌广告、4K画质展示。',
        'model.veo31.params.1': '方向：横向 16:9、纵向 9:16',
        'model.veo31.params.2': '尺寸：720p / 1080p / 4K',
        'model.veo31.params.3': '时长：固定 8 秒',
        'model.veo31.params.4': '积分：10分 / 50分 / 100分',
        ...
        // Credits page - payment methods
        'credits.method.wechat_full': '微信支付',
        'credits.method.creditcard': '信用卡',
        'credits.pkg.100': '100 积分',
        'credits.pkg.500': '500 积分',
        'credits.pkg.1000': '1000 积分',
        'credits.pkg.custom': '自定义金额',
        'credits.placeholder.custom': '输入金额',
        'credits.stripe.pay_btn': '使用 Stripe 支付',
        'credits.stripe.tip': '支持 Visa、Mastercard、American Express 等',
        'credits.wechat.tip': '扫码支付，人民币结算（1元=10积分）',
        'credits.wechat.scan_qr': '请使用微信扫描二维码完成支付',
        'credits.wechat.generating_qr': '正在生成支付二维码...',
        'credits.wechat.pay_amount': '支付金额',
        'credits.wechat.credits_amount': '充值积分',
        'credits.wechat.unit': '积分',
        'credits.wechat.waiting': '等待支付中...',
    },
    'en-US': {
        ...
        'hero.subtitle': 'One-click generation for e-commerce videos, supporting 4K Ultra HD',
        'hero.cta': 'Log In Now',
        'hero.note': 'No Credit Card Required · Free Credits for New Users',
        'feature.batch.title': 'Batch Generation',
        'feature.batch.desc': 'Up to 50 videos at once, 10 parallel tasks',
        'feature.nowatermark.title': 'No Watermark',
        'feature.nowatermark.desc': 'Commercial-grade output for e-commerce ads',
        'feature.quality.title': 'HD Quality',
        'feature.quality.desc': '720p / 1080p / 4K, up to 25s videos',
        'feature.image.title': 'Image to Video',
        'feature.image.desc': 'Upload product images, AI generates dynamic videos',
        'models.header': 'Choose Your Model',
        'stats.videos': 'Videos Generated',
        'stats.success': 'Success Rate',
        'stats.speed': 'Avg. Generation Time',
        'stats.support': 'Service Availability',
        'cta.title': 'Ready to Start Creating?',
        'cta.subtitle': 'Sign up now and experience AI video generation for free',
        'model.sora2.label': 'Sora2',
        ...
        'model.veo31.label': 'Veo 3.1',
        'model.veo31.desc': 'Ideal for premium brand ads and 4K quality showcase.',
        'model.veo31.params.1': 'Orientation: Landscape 16:9, Portrait 9:16',
        'model.veo31.params.2': 'Size: 720p / 1080p / 4K',
        'model.veo31.params.3': 'Duration: Fixed 8s',
        'model.veo31.params.4': 'Credits: 10 pts / 50 pts / 100 pts',
        ...
        'lang.toggle': 'English/中文',
        // Credits page - payment methods
        'credits.method.wechat_full': 'WeChat Pay',
        'credits.method.creditcard': 'Credit Card',
        'credits.pkg.100': '100 Credits',
        'credits.pkg.500': '500 Credits',
        'credits.pkg.1000': '1000 Credits',
        'credits.pkg.custom': 'Custom Amount',
        'credits.placeholder.custom': 'Enter amount',
        'credits.stripe.pay_btn': 'Pay with Stripe',
        'credits.stripe.tip': 'Supports Visa, Mastercard, American Express, etc.',
        'credits.wechat.tip': 'Scan to pay, CNY settlement (1 CNY = 10 Credits)',
        'credits.wechat.scan_qr': 'Please scan QR code with WeChat to complete payment',
        'credits.wechat.generating_qr': 'Generating payment QR code...',
        'credits.wechat.pay_amount': 'Payment Amount',
        'credits.wechat.credits_amount': 'Credits to Add',
        'credits.wechat.unit': 'Credits',
        'credits.wechat.waiting': 'Waiting for payment...',
    },
};
